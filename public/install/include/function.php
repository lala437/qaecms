...
function env_check(&$env_items) {
	...
	$env_items[] = array('name' => 'PHP版本', 'min' => '7.1', 'good' => '7.4', 'cur' => PHP_VERSION, 'status'=>(PHP_VERSION < 7.1 ? 0:1));
	$fileinfo = in_array('fileinfo',get_loaded_extensions());
	$env_items[] = array('name' => 'FileInfo', 'min' => '已安装', 'good' => '已安装', 'cur' => $fileinfo?"已安装":"未安装", 'status'=>($fileinfo?1:0));
