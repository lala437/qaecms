  ...
  <div class="step-box" id="step2">
    <div class="text-nav">
      ...
      <div class="procedure-nav">
          ...
          <div class="schedule-text"><span class="a">检查安装环境</span><span class="b">创建数据库</span><span class="c">安装</span><span class="d">完成</span></div>
      </div>
  </div>
    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db_name" maxlength="40" value="<?php echo $_POST['db_name'] ? $_POST['db_name'] : 'qaecms';?>">
          </span> <em></em></div>
        <div>
          <label>数据库用户名</label>
          <span>
