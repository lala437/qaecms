...
@section('content')
    ...
    <div class="layui-row text-center">
        <i class="layui-icon layui-icon-close layui-circle" style="background: #52C41A;color: #fff;font-size:30px;font-weight:bold;padding: 20px;line-height: 80px;"></i>
        <div style="font-size: 24px;color: red;margin-top: 30px;">支付失败</div>
