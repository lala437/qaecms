...
<div class="more-theme-list">
    <div class="more-theme-item active">
        <img src="{{asset('assets/module/img/theme-admin.png')}}"/>
    </div>
    <div class="more-theme-item" data-theme="theme-cyan">
        <img src="{{asset('assets/module/img/theme-cyan.png')}}"/>
    </div>
    <div class="more-theme-item" data-theme="theme-white">
        <img src="{{asset('assets/module/img/theme-white.png')}}"/>
    </div>
    <div class="more-theme-item" data-theme="theme-pink">
        <img src="{{asset('assets/module/img/theme-pink.png')}}"/>
    </div>
    <div class="more-theme-item" data-theme="theme-colorful">
        <img src="{{asset('assets/module/img/theme-colorful.png')}}"/>
    </div>
    <div class="more-theme-item" data-theme="theme-blue">
        <img src="{{asset('assets/module/img/theme-blue.png')}}"/>
    </div>
    <div class="more-theme-item" data-theme="theme-green">
        <img src="{{asset('assets/module/img/theme-green.png')}}"/>
    </div>
    <div class="more-theme-item" data-theme="theme-purple">
        <img src="{{asset('assets/module/img/theme-purple.png')}}"/>
    </div>
    <div class="more-theme-item" data-theme="theme-red">
        <img src="{{asset('assets/module/img/theme-red.png')}}"/>
    </div>
</div>
<!-- 导航 -->
<!-- 控制开关 -->
